...
<h1 style="text-align:center;font-size: 35px;font-family: Engravers MT;
border-bottom: solid #078fe8;border-top: solid #078fe8;padding: 30px 0px 30px 0px;"> Testimonials</h1>  
  

  <h3>Sara Rigley</h3>
  <p>"I have played many outdoor games, but these were my favorite!"</p>
  <h3>George Field</h3>
  <p>"I got a hole-in-one! It was awesome!"</p>
  <h3>Kurt Bryan</h3>
  <p>"I played these games all day, and I could play all night!"</p>
</div>
